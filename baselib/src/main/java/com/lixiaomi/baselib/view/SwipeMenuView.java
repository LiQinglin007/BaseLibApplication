...
public class SwipeMenuView extends ViewGroup {
     ...
     * @param mIsIos
     */
    public SwipeMenuView setmIsIos(boolean mIsIos) {
        this.mIsIos = mIsIos;
        return this;
    }

    public boolean ismIsLeftSwipe() {
        return mIsLeftSwipe;
    }
     ...
     * @return
     */
    public SwipeMenuView setmIsLeftSwipe(boolean mIsLeftSwipe) {
        this.mIsLeftSwipe = mIsLeftSwipe;
        return this;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.SwipeMenuView_swipeEnable) {
                mIsSwipeEnable = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.SwipeMenuView_ios) {
                mIsIos = ta.getBoolean(attr, true);
            } else if (attr == R.styleable.SwipeMenuView_leftSwipe) {
                mIsLeftSwipe = ta.getBoolean(attr, true);
            }
        }
        ta.recycle();
    }
    ...
    public void smoothExpand() {
        ...
        cancelAnim();
        mExpandAnim = ValueAnimator.ofInt(getScrollX(), mIsLeftSwipe ? mRightMenuWidths : -mRightMenuWidths);
