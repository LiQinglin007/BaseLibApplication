...
public class DownloadService extends Service {
     ...
     * 初始化下载器
     */
    private void initDownManager(String downLoadUrl, String downLoadTitle, String downloadTag) {
        ...
        miEventMessage.setMessageString(downloadTag);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        String downloadUrl = intent.getStringExtra(MiFinalData.DOWNLOAD_URL);
        String downloadTitle = intent.getStringExtra(MiFinalData.DOWNLOAD_TITLE);
        String downloadTag = intent.getStringExtra(MiFinalData.DOWNLOAD_TAG);
        // 调用下载
        initDownManager(downloadUrl, downloadTitle, downloadTag);
                        ...
                        case DownloadManager.STATUS_SUCCESSFUL:
                            ...
                            if (null != filePath && !TextUtils.isEmpty(filePath)) {
                                if (filePath.contains(".apk")) {
                                    ...
                                    MiEventMessage miEventMessage = new MiEventMessage(MiEventMessage.DOWNLOAD_FINISH);
